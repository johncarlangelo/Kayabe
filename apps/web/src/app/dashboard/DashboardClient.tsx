...
export function DashboardClient({ user }: DashboardClientProps) {
  ...
  return (
    <div className="min-h-screen bg-[#080b12] text-slate-100 flex flex-col">
      {/* Top Navbar */}
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#0d111d]/80 backdrop-blur-xl">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#5b58d9] via-[#4845b8] to-[#2a267a] p-6 sm:p-8 border border-white/15 shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl space-y-2.5">
            ...
            <p className="text-white/80 text-sm sm:text-base leading-relaxed">
              You are securely signed in through Supabase Authentication. Explore your projects and collaborative task boards below.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="group p-5 rounded-2xl bg-[#101423]/80 hover:bg-[#151a2e] border border-white/10 hover:border-indigo-500/40 transition-all cursor-pointer space-y-3">
              ...
              <div>
                <h4 className="text-sm font-semibold text-white">Kanban Boards</h4>
                <p className="text-xs text-slate-400 mt-1">Manage sprint tasks and workflows</p>
              </div>
            </div>
